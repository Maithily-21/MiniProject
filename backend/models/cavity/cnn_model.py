...
class CavityCNN(nn.Module):
    ...
    Architecture:
        ...
        Head:    FC(256→128) → ReLU → Dropout(0.5) → FC(128→1)

    GlobalAvgPool replaces the old large Flatten→FC(32768→256) layer,
    reducing parameters from ~8.4 M to ~200 K and improving generalisation
    on small datasets.
    """
